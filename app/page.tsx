...
export default function HomePage() {
  return (
    <div className="space-y-4 sm:space-y-6 md:space-y-8">
      ...
      <section className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl shadow-sm border border-gray-200 p-4 sm:p-6 md:p-8 text-center">
        <div className="flex flex-col items-center gap-3 sm:gap-4 md:gap-5">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#3f2a1d]">Urban Bhatti</h1>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2.5 sm:gap-3 w-full max-w-md">
            <a
              href="/menu"
              className="inline-flex items-center justify-center rounded-lg bg-[#f97316] px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-xs sm:text-sm md:text-base font-semibold text-white shadow-sm hover:bg-[#ea580c] transition-colors active:scale-95 touch-manipulation"
            >
              Explore Menu
            </a>
            <a
              href="/signup"
              className="inline-flex items-center justify-center rounded-lg border-2 border-[#3f2a1d] bg-white px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-xs sm:text-sm md:text-base font-semibold text-[#3f2a1d] hover:bg-[#3f2a1d] hover:text-white transition-colors active:scale-95 touch-manipulation"
            >
              Create Account
            </a>
          </div>
        ...
        {highlightCards.map((card) => (
          ...
          >
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <span className="inline-flex items-center gap-1 text-xs sm:text-sm font-semibold text-[#f97316] mt-2 sm:mt-3">
                Learn more
      ...
      <section className="bg-[#f97316] rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 text-center text-white">
        <div className="space-y-3 sm:space-y-4">
          ...
          <a
            href="/menu"
            className="inline-flex items-center justify-center rounded-lg bg-white px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-[#f97316] shadow-sm hover:bg-gray-50 transition-colors active:scale-95 touch-manipulation"
          >
            View Menu
          </a>
        </div>
